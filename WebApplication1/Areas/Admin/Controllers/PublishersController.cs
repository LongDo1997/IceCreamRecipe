...
namespace WebApplication1.Areas.Admin.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Phone,Address")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Phone,Address")] Publisher publisher)
        {
            if (ModelState.IsValid)
            {
